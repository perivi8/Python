...
# # ex 1
z = open('./31 - File lo/31 - harifile.txt' , 'r')
print(z.read())
...
z1 = open('./31 - File lo/31 - harifile1.txt','w')   # write 'w' is used to create a new file
...
z2 = open('./31 - File lo/31 - harifile2.txt','w')  
...
z3 = open('./31 - File lo/31 - harifile3.txt' , 'a')
print(z3.write('gf')) 

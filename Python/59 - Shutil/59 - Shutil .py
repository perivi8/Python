...
shutil.copy('./59 - Shutil/59 - Shutil .py' , './59 - Shutil/59- 1 - Shutil .py')

#--------------------------------------------------------------------------------------------------------------

# If we want to copy the folder and inside the folder files means ..

shutil.copytree('./59 - Shutil/59 - Shutil example' , './59 - Shutil/59- 2 - Shutil .txt')

# ----------------------------------------------------------------------------------------------------------

# If we want to move particulat file from folder to Present Direcatry path..

shutil.move("./59 - Shutil example/file.txt", "./59 - Shutil/file.txt")

#-----------------------------------------------------------------------------------------------------------

# If we want to remove the Folder means 

shutil.rmtree('./59 - Shutil/59- 2 - Shutil .txt')
...
os.remove('./59 - Shutil/59- 2 - Shutil .txt/hari.html')
